  ...
  return (
    <div className={`productWindow ${showcase ? "productWindowLarge" : "productWindowHero"}`}>
      <div className="windowBar">
        <Image src="/brand/tradeguard-mark.png" alt="" width={18} height={18} />
      ...
      <div className="windowBody">
        <div className="appBrand">
          <Image src="/brand/tradeguard-mark.png" alt="" width={36} height={36} />
          <div><strong>TradeGuard</strong><small>Discipline &amp; Risk Control</small></div>
        </div>
        <div className="statusHero">
          <div className="shieldHalo">
            <Image src="/brand/tradeguard-mark.png" alt="TradeGuard shield" width={showcase ? 54 : 50} height={showcase ? 54 : 50} />
          </div>
