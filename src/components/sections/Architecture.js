const flow = [
  ...
  ["Monitoring", "LimitPact reads", "neutral"],
    ...
    <section className="band sectionPad">
      <div className="container twoCol architectureGrid">
        <div className="sectionCopy">
          ...
          <p>The Tradovate integration supplies the account information LimitPact needs. LimitPact evaluates that information against your predefined rules, and the protection mechanism is enforced locally on your computer.</p>
