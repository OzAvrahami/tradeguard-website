  ...
  return (
    <section className="showcaseBand sectionPad">
      <div className="container">
        <div className="sectionHeading centered"><span className="kicker">The product</span><h2>A real desktop app, always in the corner.</h2><p>LimitPact runs as a lightweight Windows application beside your trading platform — monitoring, never intervening in your orders.</p></div>
